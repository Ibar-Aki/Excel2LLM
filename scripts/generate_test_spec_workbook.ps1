...
TC-IT-001	bat 入口 usage 表示	run_*.bat	引数不足時に Mandatory prompt に落ちず usage を返すことを確認	bat 6本	bat ファイルが存在	1) 引数なし実行 | 2) -h / --help / /? 実行	終了コード 1 | Usage 表示 | docs\guides 参照表示	自動	Pass (2026-03-28)	run_tests.bat / Excel2LLM.Tests.ps1
